...
class buffercode_category_widget_info extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'buffercode_category_widget_info', 'description' => 'Select the category to display' );
        parent::__construct( 'buffercode_category_widget_info', 'BC Category Widget', $widget_ops );
    }
