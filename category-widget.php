...
if ( isset( $instance[ 'bc_no_post' ]) && isset ($instance[ 'bc_category' ]) && isset ($instance[ 'bc_name' ])  && isset ($instance[ 'bc_bullet' ]) && isset ($instance[ 'bc_title_count' ]) && isset ($instance[ 'bc_combo_list' ])) {
