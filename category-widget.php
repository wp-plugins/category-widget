...
if ( isset( $instance[ 'buffercode_no_post' ]) && isset ($instance[ 'buffercode_category' ]) && isset ($instance[ 'buffercode_name' ])  && isset ($instance[ 'buffercode_bullet' ]) && isset ($instance[ 'buffercode_title_count' ]) && isset ($instance[ 'buffercode_combo_list' ]) &&isset ($instance[ 'buffercode_please_select'])) {
...
$after_title; };
if($buffercode_no_post_value==11){$args = array('category' => $buffercode_category_value,'posts_per_page'   => -1 );}
else{ $args = array('category' => $buffercode_category_value,'posts_per_page'   => $buffercode_no_post_value );}
...
add_action( 'wp_head', 'buffercode_category_widget_script_new' );

function buffercode_category_widget_script_new() {
echo '<script>
